...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Caffezin\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=+556198302738:+55 6198302738\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','#'
blocked = []
limitawal = '999999999'
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Olá @${num.split('@')[0]}\nBem vindo ao grupo *${mdata.subject}*\n\nEspero que goste, leia as regras`
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD Caffezin BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] Este é um recurso especial para o Caffezin ❌',
					ownerB: '[❗] Este é um recurso especial para o Caffezin ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de Caffezin. Registre-se para fazer amizade com o bot Caffezin por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Caffezin|13\n\n──「 Caffezin Bot 」──`,
			...
			const mod = [ownerNumber,"556198302738@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["556198302738@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["556198302738@s.whatsapp.net"]//ubah nomor lo
			const premium = ["556198302738@s.whatsapp.net","558296156440@s.whatsapp.net"] 
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
		...
		if (isGroupAdmins) return reply('cara, nao fale essas coisas, é errado')
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS Caffezin BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @Caffezin
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o Caffezin ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT Caffezin ✨* 」\n*│+ wa.me/556198302738*╰──────*「 *Caffezin* 」*────*\n\n*_SE QUER SER ADMIN DO BOT Caffezin_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do Caffezi:*\n\n https://'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
